...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // mount the ⚙️ preferences on the video frame (or pass another container)
  try { mountPrefs(frameEl || document.body); } catch {}

  // Ensure proper stacking: frame establishes a positioning context,
  // overlay sits on top of the absolutely-positioned <video>.
